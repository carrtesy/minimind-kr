...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind-KR 사전학습")
    parser.add_argument("--save_dir", type=str, default="../out", help="모델 저장 디렉터리")
    parser.add_argument('--save_weight', default='pretrain', type=str, help="저장할 가중치의 접두사 이름")
    ...
    parser.add_argument('--max_seq_len', default=340, type=int, help="학습 시 최대 절단 길이 (한국어 토큰당 문자 수는 tokenizer/데이터에 따라 다름)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_t2t_mini.jsonl", help="사전학습 데이터 경로")
    parser.add_argument('--from_weight', default='none', type=str, help="어떤 가중치를 기반으로 학습할지. none인 경우 처음부터 학습")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Pretrain", help="wandb 프로젝트명")
