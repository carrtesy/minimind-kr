...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind-KR LoRA 파인튜닝")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/lora_medical.jsonl", help="LoRA 학습 데이터 경로")
    parser.add_argument('--from_weight', default='full_sft', type=str, help="기반이 되는 가중치. 기본값은 full_sft")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-LoRA", help="wandb 프로젝트명")
    ...
    if args.use_compile == 1:
        args.use_compile = 0
        Logger('[LoRA] monkey-patch forward는 torch.compile과 호환되지 않아 use_compile이 자동으로 비활성화되었습니다')
