...
# QwenForCausalLM/LlamaForCausalLM 구조 생태계 호환
...
def convert_merge_base_lora(base_torch_path, lora_path, merged_torch_path):
    ...
    print(f"LoRA가 병합되어 베이스 모델 구조 PyTorch 형식으로 저장되었습니다: {merged_torch_path}")
...
if __name__ == '__main__':
    ...
    transformers_path = '../minimind-kr-hf'
